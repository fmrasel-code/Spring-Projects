...
<%-- 
    Document   : addProduct
    Created on : Jan 12, 2021, 4:22:48 PM
    Author     : Rasel Ahmed
--%>
...
<div class="container-wrapper">
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/views/admin/product/addProduct" method="post"
        ...
        <a href="<c:url value="/views/admin/productInventory" />" class="btn btn-default">Cancel</a>
        </form:form>
