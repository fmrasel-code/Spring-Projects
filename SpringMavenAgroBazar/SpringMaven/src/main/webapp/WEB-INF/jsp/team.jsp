<%-- 
    Document   : team
    Created on : Jan 9, 2021, 6:17:06 PM
    Author     : Rasel Ahmed
--%>
        ...
        <section class="page-header bg_img padding-tb">
            ...
            <div class="container">
                <div class="page-header-content-area">
                    <h4 class="ph-title">Agricul Farm Team</h4>
                    <ul class="agri-ul">
                        <li><a href="index.html">Home</a></li>
                        <li><a class="active">Team Membar</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/05.jpg" alt="team-image">
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/06.jpg" alt="team-image">
                                    </div>
                                    <div class="team-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/07.jpg" alt="team-image">
                                    </div>
                                    <div class="team-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/08.jpg" alt="team-image">
                                    </div>
                                    <div class="team-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/09.jpg" alt="team-image">
                                    </div>
                                    <div class="team-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/10.jpg" alt="team-image">
                                    </div>
                                    <div class="team-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/12.jpg" alt="team-image">
                                    </div>
                                    <div class="team-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                            <div class="team-item-2">
                                <div class="team-inner">
                                    <div class="team-thumb">
                                        <img src="resources/assets/images/team/11.jpg" alt="team-image">
                                    </div>
                                    <div class="team-content">
