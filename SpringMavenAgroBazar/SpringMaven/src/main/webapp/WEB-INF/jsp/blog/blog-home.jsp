<%-- 
    Document   : blog-home
    Created on : Jan 9, 2021, 5:34:42 PM
    Author     : Rasel Ahmed
--%>
        ...
        <section class="page-header bg_img padding-tb">
            ...
            <div class="container">
                <div class="page-header-content-area">
                    <h4 class="ph-title">Agricul Farm Blog Page</h4>
                    <ul class="agri-ul">
                            ...
                            <article>
								...
								<div class="post-item-2">
									<div class="post-inner">
										<div class="post-thumb">
											<a href="blog-single.html">
												<img src="resources/assets/images/blog/06.jpg" alt="blog">
											</a>
										</div>
										<div class="post-content">
											<ul class="agri-ul post-date">
		...
		<footer class="footer-section padding-tb pb-0">
			<div class="container">
				...
				<div class="footer-bottom">
					<p>&copy; 2020<a href="index.html" target="_blank"><span>Chashi</span></a>All Rights Reserved By<a href="#" target="_blank"><span>AgroBazar</span></a></p>
				</div>
			</div>
		</footer>
