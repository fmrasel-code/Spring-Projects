<%-- 
    ...
    Created on : Jan 9, 2021, 5:44:21 PM
    Author     : Rasel Ahmed
--%>
                            ...
                            <article>
                                <div class="post-item-2">
                                    <div class="post-inner">
                                        <div class="post-thumb">
                                            <img src="resources/assets/images/blog/04.jpg" alt="blog">
                                        </div>
                                ...
                                <div class="authors">
                                    <div class="author-thumb">
                                        <a href="#"><img src="resources/assets/images/team/02.jpg" alt="author"></a>
                                    </div>
                                    ...
                                    <div class="section-wrapper">
                                        <div class="row no-gutters justify-content-center">
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <img src="resources/assets/images/product/01.jpg" alt="food-product">
                                                    </div>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <img src="resources/assets/images/product/02.jpg" alt="food-product">
                                                    </div>
                                                    <div class="product-content">
                                                        <a href="#"><h6>Archaeologists may tunnel</h6></a>
                                                        <a href="#" class="commtents">24 Comments</a>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <img src="resources/assets/images/product/03.jpg" alt="food-product">
                                                    </div>
                                                    <div class="product-content">
                                                        <a href="#"><h6>Archaeologists may tunnel</h6></a>
                                                        <a href="#" class="commtents">24 Comments</a>
                                ...
                                <div id="comments" class="comments">
                                    ...
                                    <ul class="agri-ul comment-list">
                                        <li class="comment" id="li-comment-1">
                                            <div class="com-thumb">
                                                <img alt="" src="resources/assets/images/team/05.jpg" srcset="resources/assets/images/team/05.jpg" class="avatar avatar-90 photo" height="90" width="90">          
                                            </div>
                                            ...
                                            <ul class="agri-ul comment-list">
                                                <li class="comment" id="li-comment-2">
                                                    <div class="com-thumb">
                                                        <img alt="" src="resources/assets/images/team/06.jpg" srcset="resources/assets/images/team/06.jpg" class="avatar avatar-90 photo" height="90" width="90">
                                                    </div>
                                                    <div class="com-content">
                                                        <div class="com-title">
                                                            <div class="com-title-meta">
                                        ...
                                        <li class="comment" id="li-comment-3">
                                            <div class="com-thumb">
                                                <img alt="" src="resources/assets/images/team/07.jpg" srcset="resources/assets/images/team/07.jpg" class="avatar avatar-90 photo" height="90" width="90">
                                            </div>
                                            <div class="com-content">
                                                <div class="com-title">
                                                    <div class="com-title-meta">
                            ...
                            <aside>
                                ...
                                <div class="widget widget-instagram">
                                    ...
                                    <ul class="agri-ul widget-wrapper d-flex flex-wrap justify-content-center">
                                        <li><a href="#"><img src="resources/assets/images/product/01.jpg" alt="product"></a></li>
                                        <li><a href="#"><img src="resources/assets/images/product/02.jpg" alt="product"></a></li>
                                        <li><a href="#"><img src="resources/assets/images/product/05.jpg" alt="product"></a></li>
                                        <li><a href="#"><img src="resources/assets/images/product/06.jpg" alt="product"></a></li>
                                    </ul>
                                </div>
