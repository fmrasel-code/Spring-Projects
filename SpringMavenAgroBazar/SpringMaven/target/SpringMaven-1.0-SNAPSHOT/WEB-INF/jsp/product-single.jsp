<%-- 
    ...
    Created on : Jan 9, 2021, 4:58:06 PM
    Author     : Rasel Ahmed
--%>
...
<html lang="en">
    <head>
        <title>AgroBazar Products Single</title>
        <meta charset="UTF-8">
                        ...
                        <ul class="agri-ul">
                            ...
                            <li class="active">
                                ...
                                <ul class="agri-ul">
                                    ...
                                    <li class="active"><a href="product-single.html">Product Single</a></li>
        ...
        <section class="page-header bg_img padding-tb">
            ...
            <div class="container">
                <div class="page-header-content-area">
                    <h4 class="ph-title">Agricul Farm Products Single Page</h4>
                    <ul class="agri-ul">
                        <li><a href="index.html">Home</a></li>
                        <li><a class="active">Products Single</a></li>
                    </ul>
                </div>
            </div>
        </section>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="shop-item">
                                                        <div class="shop-thumb">
                                                            <img src="resources/assets/images/product/single/top/01.png" alt="shop-single">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                        ...
                                        <div class="swiper-container gallery-thumbs">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="shop-item">
                                                        <div class="shop-thumb">
                                                            <img src="resources/assets/images/product/single/bottom/01.png" alt="shop-single">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="shop-item">
                                                        <div class="shop-thumb">
                                                            <img src="resources/assets/images/product/single/bottom/02.png" alt="shop-single">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="shop-item">
                                                        <div class="shop-thumb">
                                                            <img src="resources/assets/images/product/single/bottom/03.png" alt="shop-single">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="shop-item">
                                                        <div class="shop-thumb">
                                                            <img src="resources/assets/images/product/single/bottom/04.png" alt="shop-single">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="shop-item">
                                                        <div class="shop-thumb">
                                                            <img src="resources/assets/images/product/single/bottom/05.png" alt="shop-single">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="review">
                            ...
                            <div class="review-content review-content-show">
                                    ...
                                    <ul class="agri-ul content">
                                        <li>
                                            <div class="post-thumb">
                                                <img src="resources/assets/images/team/01.jpg" alt="shop">
                                            </div>
                                            <div class="post-content">
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <img src="resources/assets/images/team/02.jpg" alt="shop">
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                                    <div class="posted-on">
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <img src="resources/assets/images/team/03.jpg" alt="shop">
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                                    <div class="posted-on">
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <img src="resources/assets/images/team/04.jpg" alt="shop">
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                                    <div class="posted-on">
                                ...
                                <div class="description">
                                    ...
                                    <div class="post-item">
                                        <div class="post-thumb">
                                            <img src="resources/assets/images/product/01.jpg" alt="shop">
                                        </div>
                                        <div class="post-content">
                                            <ul class="agri-ul">
                                                <li>
