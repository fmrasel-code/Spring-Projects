<%-- 
    Document   : gallery
    Created on : Jan 9, 2021, 5:23:47 PM
    Author     : Rasel Ahmed
--%>
...
<html lang="en">
    <head>
        <title>AgroBazar Gallery Masonary</title>
        <meta charset="UTF-8">
                        ...
                        <ul class="agri-ul">
                            ...
                            <li class="active">
                                ...
                                <ul class="agri-ul">
                                    ...
                                    <li class="active"><a href="gallery-masonary.html">Gallery Masonary</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">Blog</a>
        ...
        <section class="page-header bg_img padding-tb">
            ...
            <div class="container">
                <div class="page-header-content-area">
                    <h4 class="ph-title">Agricul Farm Gallery Masonary</h4>
                    <ul class="agri-ul">
                        <li><a href="index.html">Home</a></li>
                        <li><a class="active">Gallery Masonary</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="section-wrapper">
                    <div class="grid">
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/01.jpg" alt="product">
                                </div>
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/02.jpg" alt="product">
                                </div>
                                <div class="product-content">
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/03.jpg" alt="product">
                                </div>
                                <div class="product-content">
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/04.jpg" alt="product">
                                </div>
                                <div class="product-content">
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/05.jpg" alt="product">
                                </div>
                                <div class="product-content">
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/06.jpg" alt="product">
                                </div>
                                <div class="product-content">
                                    <a href="#" class="product-name">Fruits</a>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/07.jpg" alt="product">
                                </div>
                                <div class="product-content">
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/08.jpg" alt="product">
                                </div>
                                <div class="product-content">
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/09.jpg" alt="product">
                                </div>
                                <div class="product-content">
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/10.jpg" alt="product">
                                </div>
                                <div class="product-content">
                                    <a href="#" class="product-name">Cows</a>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/11.jpg" alt="product">
                                </div>
                                <div class="product-content">
                                    <a href="#" class="product-name">Cows</a>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="product-inner">
                                <div class="product-thumb">
                                    <img src="resources/assets/images/masonary/12.jpg" alt="product">
                                </div>
                                <div class="product-content">
                                    <a href="#" class="product-name">Cows</a>
                                </div>
