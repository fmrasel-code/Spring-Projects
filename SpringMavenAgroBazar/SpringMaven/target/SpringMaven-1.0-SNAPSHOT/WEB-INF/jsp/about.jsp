<%-- 
    Document   : about
    Created on : Jan 9, 2021, 6:07:13 PM
    Author     : Rasel Ahmed
--%>
        ...
        <section class="page-header bg_img padding-tb">
            ...
            <div class="container">
                <div class="page-header-content-area">
                    <h4 class="ph-title">Agricul Farm About us</h4>
                    <ul class="agri-ul">
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="counter-item">
                                <div class="counter-inner">
                                    <div class="counter-thumb">
                                        <img src="resources/assets/images/counter/01.png" alt="counter">
                                    </div>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="counter-item">
                                <div class="counter-inner">
                                    <div class="counter-thumb">
                                        <img src="resources/assets/images/counter/02.png" alt="counter">
                                    </div>
                                    <div class="counter-content">
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="counter-item">
                                <div class="counter-inner">
                                    <div class="counter-thumb">
                                        <img src="resources/assets/images/counter/03.png" alt="counter">
                                    </div>
                                    <div class="counter-content">
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="counter-item">
                                <div class="counter-inner">
                                    <div class="counter-thumb">
                                        <img src="resources/assets/images/counter/04.png" alt="counter">
                                    </div>
                                    <div class="counter-content">
                    ...
                    <div class="history-item">
                        <div class="history-inner">
                            <div class="history-thumb">
                                <img src="resources/assets/images/history/01.jpg" alt="history">
                            </div>
                                ...
                                <div class="testi-item">
                                    <div class="testi-inner">
                                        ...
                                        <div class="testi-body">
                                            <p><span class="img-left"><img src="resources/assets/images/testimonial/qute.png" alt="quete"></span>Continually Onceptualizef Technically invs Professionally monetizeturkeyf Testingdu Frofessionally oe-enablfunctaizede-come rce Onceptualize Technically initiatives.<span class="img-right"><img src="assets/images/testimonial/quete-left.png" alt="quete"></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
